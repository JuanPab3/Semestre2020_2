...
\begin{enumerate}[{a) }]
    ...
    \item Como los únicos dobles menores o iguales a cuatro son los que se
        forman con {\color{OrangeRed} 1} y {\color{Cerulean} 2}, se puede
        concluir que la probabilidad de que salgnan dobles es igual a
        {\color{MidnightBlue} \(\frac{1}{18}\)}.
    ...
    \item Revisando el \textit{punto} anterior, se puede ver que la
        ...
        mismo cálculo pero con una opción menos; siendo esto igual {\color{Cyan}\(\frac{5}{18}\)}.
\end{enumerate}
